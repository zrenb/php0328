    ...
    <table>
        ...
        <tr data-id="<?=$good['id']?>">
         ...
         <td class="col4">
            ...
            <td class="col6"><a href="" class="goods_del">删除</a></td>
        </tr>
        <?php endforeach;?>
        </tbody>
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php ?></span></strong></td>
        </tr>
        </tfoot>
    </table>
    <div class="cart_btn w990 bc mt10">
        <a href="<?=\yii\helpers\Url::to(['goods/index'])?>" class="continue">继续购物</a>
        <a href="<?=\yii\helpers\Url::to(['order/goods-list'])?>" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
