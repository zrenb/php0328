...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="cart fl">
            <dl>
                <dt>
                    <a href="<?=\yii\helpers\Url::to(['order/goods-list'])?>">去购物车结算</a>
                    <b></b>
                </dt>
                <dd>
                    <div class="prompt">
                    ...
                    <div class="cat item1">
                        ...
                        <div class="cat_detail">
                            <?php foreach ($category->children as $children):?>
                                <dl class="dl_1st">
                                    <dt><a href="goods-list?category_id=<?=$children->id?>"><?=$children->name?></a></dt>
                                    <dd>
                                        <?php foreach ($children->child as $child):?>
                                            <a href="goods-list?category_id=<?=$child->id?>"><?=$child->name?></a>
                                        <?php endforeach;?>
                                    </dd>
                                </dl>
                            <?php endforeach;?>
...
<script>
    ...
    $('.btn').click(function () {
       var a = $('txt').text();
        $.get('goods/sou',{a:a}.serialize(),function (data) {
            console.debug(data);
        })
    })
</script>
