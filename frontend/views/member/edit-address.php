    ...
    <!-- 右侧内容区域 start -->
            ...
            <ul>
                ...
                <li id="name">
                    ...
                    <input type="text" name="Abres[name]" class="txt" value="<?=$address->name?>"/>
                    <p></p>
                </li>
                <li>
                ...
                <li id="detail">
                    ...
                    <input type="text" name="Abres[detail]" class="txt address" value="<?=$address->detail?>" />
                    <p></p>
                </li>
                <li id="tel">
                    <label for=""><span>*</span>手机号码：</label>
                    <input type="text" name="Abres[tel]" class="txt" value="<?=$address->tel?>"/>
                    <p></p>
                </li>
                <li>
                    <label for="">&nbsp;</label>
                    <input type="checkbox" name="Abres[status]" class="check" value="<?=$address->status?>"/>设为默认地址
                </li>
                <li>
                    <label for="">&nbsp;</label>
...
<script>
    ...
    //会显赋值
    //console.debug("<?=$address->province?>");
    $('#province').val("<?=$address->province?>"); //回显省
    $('#province').change();
    $('#city').val("<?=$address->city?>"); //回显市
    $('#city').change();
    $('#area').val("<?=$address->area?>"); //回显区县
